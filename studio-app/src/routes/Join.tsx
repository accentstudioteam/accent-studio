      ...
      <div className="app">
        ...
        <div className="shell">
          ...
          <div className="sheet" style={{ marginBottom: 18 }}>
            ...
            <div className="tile"><div className="tlbl">Who hears you</div><div className="tbody">The partner you're paired with hears your live voice during a session and never gets your name, contact details or a copy. Our trained linguists listen to verify transcripts.</div></div>
