...
type View = "home" | "settings" | "applications" | "labs" | "cards" | "verify" | "integrity";
...
export function Studio() {
  ...
  return <Home onSettings={() => setView("settings")} onApplications={() => setView("applications")} onLabInquiries={() => setView("labs")} onCards={() => setView("cards")} onVerify={() => setView("verify")} onIntegrity={() => setView("integrity")} />;
}
