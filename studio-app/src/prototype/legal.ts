...
const IP_ASSIGNMENT: Agreement = {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        "You retain the non-waivable statutory rights afforded by applicable data-protection law, including rights of access, rectification, portability, and erasure of identifiable data, and the right to withdraw consent. Withdrawal of consent operates prospectively: it halts future collection and processing of newly identifiable data but does not require recall of anonymized User Content or Derived Materials that can no longer be associated with you and that have already been incorporated into datasets or models delivered to third parties. Requests may be made through the in-app Data & Privacy controls or by contacting the Company's data protection contact.",
    },
    {
